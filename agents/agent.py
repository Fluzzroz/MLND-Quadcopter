...
class DDPG():
    ...
    def __init__(self, task):
        ...
        # Noise process
        self.exploration_mu = 0  # default 0
        self.exploration_theta = 0.08  # default 0.15
        self.exploration_sigma = 0.1  # default 0.2
        ...
        self.tau = 0.005  # for soft update of target parameters / default 0.01
